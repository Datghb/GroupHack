...
create unique index if not exists product_submissions_assignment_team_unique
  on public.product_submissions (assignment_id, team_id);
create unique index if not exists product_reviews_submission_team_unique
  on public.product_reviews (submission_id, reviewer_team_id);
create index if not exists product_submissions_assignment_idx
  on public.product_submissions (assignment_id);
create index if not exists product_reviews_submission_idx
  on public.product_reviews (submission_id);
