...
create index if not exists product_discussion_submission_created_idx on public.product_discussion_comments (submission_id, created_at);
create index if not exists product_discussion_parent_idx on public.product_discussion_comments (parent_id);
